    ...
    >
      ...
      <div className="flex items-center gap-4">
        <button
          ...
          className="lg:hidden flex items-center gap-2 text-xs tracking-widest uppercase font-['DM_Sans'] transition-colors px-4 py-2 border"
          style={{
      ...
      <div className="flex items-center gap-4">
        ...
        <select
          ...
          className="text-xs tracking-wide font-['DM_Sans'] px-3 py-2 border outline-none cursor-pointer"
          style={{
        ...
        >
          <button
            ...
            style={{
              ...
              color: view === "grid" ? "#000" : "var(--text-muted)",
            }}
          >
            <LayoutGrid size={14} />
          </button>
