      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <button onClick={() => refetch()}
            className="w-9 h-9 flex items-center justify-center border transition-opacity hover:opacity-70"
      ...
      {showForm && (
        <div className="border p-6 space-y-5" style={{ backgroundColor: "var(--card-bg)", borderColor: "var(--accent)" }}>
          ...
          <form onSubmit={handleAdd} className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input required type="email" value={newAdmin.email}
                  ...
                  className={inputClass} style={inputStyle} placeholder="admin@example.com" />
              </div>
            </div>
            <div className="grid grid-cols-2 gap-4">
              <div>
            ...
            <div className="p-4 text-xs font-['DM_Sans'] space-y-1"
            ...
            {formError && (
              <p className="text-xs font-['DM_Sans'] px-3 py-2 border"
            ...
            <div className="flex gap-3">
              <button type="button" onClick={() => { setShowForm(false); setFormError(""); }}
                className="px-6 py-3 text-xs font-bold tracking-widest uppercase font-['DM_Sans'] border hover:opacity-70"
                style={{ borderColor: "var(--border)", color: "var(--text-secondary)" }}>
                Cancel
              </button>
              <button type="submit" disabled={creating}
                className="flex items-center gap-2 px-6 py-3 text-xs font-bold tracking-widest uppercase font-['DM_Sans'] hover:opacity-80 disabled:opacity-50"
                style={{ backgroundColor: "var(--accent)", color: "#000" }}>
                {creating
  ...
  <div key={admin.id}
    ...
    <div className="flex items-center gap-4">
      <div className="w-10 h-10 flex items-center justify-center text-sm font-black font-['Playfair_Display'] flex-shrink-0"
        style={{
          ...
          color: admin.role === "superadmin" ? "#000" : "var(--accent)",
        }}>
    ...
    <div className="flex items-center gap-3">
      <button
        ...
        className="text-[10px] font-bold tracking-widest uppercase px-2.5 py-1 font-['DM_Sans'] transition-opacity hover:opacity-70"
