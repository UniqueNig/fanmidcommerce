...
function UserDetailModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center px-4">
      ...
      />
      <div
        className="relative w-full max-w-sm border p-6 space-y-5"
        style={{
      ...
      >
        ...
        <div className="flex items-center gap-4">
          <div
            className="w-12 h-12 flex items-center justify-center text-lg font-black font-['Playfair_Display'] flex-shrink-0"
            style={{
              backgroundColor:
  ...
  if (error) {
    return (
      <div className="flex flex-col items-center justify-center py-32 gap-4">
        ...
        <button
          onClick={() => refetch()}
          className="flex items-center gap-2 px-5 py-2.5 text-xs font-bold tracking-widest uppercase font-['DM_Sans'] border hover:opacity-70"
          style={{
            borderColor: "var(--border)",
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {[
          ...
          {
            label: "Total Revenue",
            value: `₦${customers.reduce((s, c) => s + (c.spent ?? 0), 0).toFixed(0)}`,
          },
        ].map(({ label, value }) => (
          <div
            key={label}
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                        <div
                          className="w-8 h-8 flex items-center justify-center text-xs font-black font-['Playfair_Display'] flex-shrink-0"
                          style={{
                            backgroundColor:
                              "color-mix(in srgb, var(--accent) 15%, transparent)",
                            color: "var(--accent)",
                    ...
                    <td className="px-6 py-4">
                      <button
                        ...
                        disabled={toggling}
                        className="text-[10px] font-bold tracking-widest uppercase px-2.5 py-1 font-['DM_Sans'] transition-opacity hover:opacity-70 disabled:opacity-40"
                        style={
