                  ...
                  <tr key={product.id}
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                        <div className="w-10 h-12 shrink-0 overflow-hidden" style={{ backgroundColor: "var(--bg-secondary)" }}>
                          {product.image
                            ? <img src={product.image} alt={product.name} className="w-full h-full object-cover" />
                            : <div className="w-full h-full" />}
                        </div>
                        <span className="text-sm font-medium font-['DM_Sans']" style={{ color: "var(--text-primary)" }}>
                          {product.name}
                        </span>
                      </div>
                    </td>
                    ...
                    {/* Category */}
                    <td className="px-6 py-4">
                      <span className="text-xs font-['DM_Sans']" style={{ color: "var(--text-secondary)" }}>
                        {product.category}
                      </span>
                    </td>
                    ...
                    {/* Price */}
                    <td className="px-6 py-4">
                      <span className="font-bold font-['DM_Sans'] text-sm" style={{ color: "var(--accent)" }}>
                    ...
                    <td className="px-6 py-4">
                      <span className="text-sm font-['DM_Sans']"
                        style={{ color: product.stock < 5 ? "#ef4444" : "var(--text-primary)" }}>
                        {product.stock}
                        {product.stock < 5 && (
