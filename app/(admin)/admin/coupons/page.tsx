...
const inputClass =
  "w-full px-3 py-2 text-sm font-['DM_Sans'] outline-none border transition-all";
const inputStyle = {
        ...
        <div className="border p-5 space-y-4" style={{ backgroundColor: "var(--card-bg)", borderColor: "var(--accent)" }}>
          ...
          <div className="flex gap-2">
            <button onClick={addCoupon} disabled={creating}
              className="flex items-center gap-2 px-5 py-2 text-xs font-bold tracking-widest uppercase font-['DM_Sans'] hover:opacity-80 disabled:opacity-50"
              style={{ backgroundColor: "var(--accent)", color: "#000" }}>
              ...
              <div key={c.id} className="px-6 py-4 flex items-center justify-between">
                <div>
                  <div className="flex items-center gap-3 mb-0.5">
                    ...
                    <span className="text-[10px] font-['DM_Sans'] px-2 py-0.5 font-bold"
                ...
                <div className="flex items-center gap-3">
                  <button onClick={() => toggleActive(c)}
                    className="text-[10px] font-bold tracking-widest uppercase font-['DM_Sans'] px-3 py-1.5 border transition-opacity hover:opacity-70"
                    style={{
