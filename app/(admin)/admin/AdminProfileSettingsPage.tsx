  ...
  return (
    <div className="space-y-8 max-w-2xl">
      ...
      <div className="flex items-center gap-5">
        <div className="w-16 h-16 flex items-center justify-center text-2xl font-black font-['Playfair_Display'] flex-shrink-0"
        ...
        <form onSubmit={pwFormik.handleSubmit} className="space-y-4">
          ...
          <div className="flex justify-end">
            <button type="submit" disabled={pwLoading}
              ...
              style={{ backgroundColor: pwSaved ? "#22c55e" : "var(--accent)", color: "#000" }}>
  ...
  return (
    <div className="space-y-6 max-w-2xl">
      ...
      <form onSubmit={formik.handleSubmit} className="space-y-5">
        ...
        {/* Payments */}
        <div className="border p-6 space-y-4" style={{ backgroundColor: "var(--card-bg)", borderColor: "var(--border)" }}>
          <div className="flex items-center gap-2">
