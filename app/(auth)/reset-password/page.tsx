    ...
    return (
      <AuthCard title="Password updated" subtitle="You can now sign in with your new password."
        ...
        <div className="flex flex-col items-center gap-4 py-4">
          ...
          <Link href="/login" className="px-8 py-3 text-xs font-bold tracking-widest uppercase font-['DM_Sans'] hover:opacity-80"
  ...
  return (
    <AuthCard title="Set a new password" subtitle="Choose a strong password you'll remember"
      ...
      <form onSubmit={submit} className="flex flex-col gap-5">
        ...
        {error && (
          <div className="px-4 py-3 text-sm font-['DM_Sans'] border"
...
export default function ResetPasswordPage() {
  return (
    <Suspense fallback={<div className="min-h-screen flex items-center justify-center" style={{ backgroundColor: "#080808" }}><Loader2 className="animate-spin" size={24} /></div>}>
      <ResetContent />
    </Suspense>
  );
}
