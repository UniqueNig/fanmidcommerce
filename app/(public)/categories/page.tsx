      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10 py-16">
        {categories.length === 0 ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {categories.map((cat) => (
              <Link key={cat.slug} href={`/categories/${cat.slug}`} className="group relative overflow-hidden aspect-[4/3] block" style={{ backgroundColor: "var(--card-bg)" }}>
                {cat.image ? (
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6">
                  <p className="text-white/60 text-[10px] tracking-widest uppercase font-['DM_Sans'] mb-1">
                  ...
                  <div className="flex items-end justify-between">
                    <div>
                      ...
                      {cat.description && (
                        <p className="text-white/60 text-xs font-['DM_Sans'] mt-1">{cat.description}</p>
                      )}
                    </div>
