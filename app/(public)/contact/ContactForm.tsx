  ...
  return (
    <form onSubmit={submit} className="space-y-5">
      ...
      <button type="submit" disabled={loading || sent}
        className="flex items-center gap-2 px-8 py-3.5 text-xs font-bold tracking-widest uppercase font-['DM_Sans'] hover:opacity-80 transition-opacity disabled:opacity-60"
        style={{ backgroundColor: sent ? "#22c55e" : "var(--accent)", color: "#000" }}>
