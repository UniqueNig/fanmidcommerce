    ...
    return (
      <main style={{ backgroundColor: "var(--bg-primary)", minHeight: "100vh" }}>
        ...
        <div className="flex flex-col items-center justify-center min-h-screen gap-4">
          ...
          <a href="/shop" className="px-6 py-3 text-xs font-bold tracking-widest uppercase font-['DM_Sans']"
            style={{ backgroundColor: "var(--accent)", color: "#000" }}>Shop Now</a>
        </div>
      </main>
    );
  }
      ...
      <main style={{ backgroundColor: "var(--bg-primary)", minHeight: "100vh" }}>
        ...
        <div className="max-w-6xl mx-auto px-6 lg:px-10 pt-32 pb-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_380px] gap-10">
            ...
            <div>
                ...
                <div className="border p-6 space-y-5" style={{ backgroundColor: "var(--card-bg)", borderColor: "var(--border)" }}>
                  ...
                  <div className="flex gap-3">
                    <button onClick={() => setStep(0)}
                      className="px-6 py-4 text-sm font-bold tracking-widest uppercase font-['DM_Sans'] border transition-opacity hover:opacity-70"
                      style={{ borderColor: "var(--border)", color: "var(--text-secondary)" }}>
                      Back
                    </button>
                    <button onClick={() => setStep(2)}
                      className="flex-1 py-4 text-sm font-bold tracking-widest uppercase font-['DM_Sans'] hover:opacity-80 transition-opacity"
                      style={{ backgroundColor: "var(--accent)", color: "#000" }}>
                      Continue to Payment
                    </button>
                  </div>
              ...
              {step === 2 && (
                <div className="border p-6 space-y-5" style={{ backgroundColor: "var(--card-bg)", borderColor: "var(--border)" }}>
                  ...
                  {/* Review */}
                  <div className="p-4 space-y-1" style={{ backgroundColor: "var(--bg-secondary)" }}>
                  ...
                  <button onClick={() => setStep(1)}
                    className="w-full py-3 text-xs font-bold tracking-widest uppercase font-['DM_Sans'] border transition-opacity hover:opacity-70"
                    style={{ borderColor: "var(--border)", color: "var(--text-secondary)" }}>
                    Back to Shipping
                  </button>
                </div>
            ...
            {/* Right — order summary */}
            <div className="border p-6 space-y-5 sticky top-28 self-start" style={{ backgroundColor: "var(--card-bg)", borderColor: "var(--border)" }}>
              <h2 className="text-xs tracking-[0.2em] uppercase font-bold font-['DM_Sans']" style={{ color: "var(--text-muted)" }}>
                Order Summary
              </h2>
